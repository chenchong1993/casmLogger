...
public class LocationUtils {
    ...
    private static final long REFRESH_TIME = 2000L;//时间更新间隔
    private static final float METER_POSITION = 0.0f;//位置刷新距离
    private static ILocationListener mLocationListener;//自定义接口
